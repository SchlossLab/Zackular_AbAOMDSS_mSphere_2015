...
*   Those community structures result in differing numbers of tumors
    -   Tumor count strip chart
    -   Very different starting communities goes to similar and different numbers
        of tumors
    -   End point phylum-level representation cannot explain the different/similar
        levels of tumors
...
1. To test the hypothesis that gut microbiome structure mediates tumorigenesis, we
...
mice with combinations of metronidazole, streptomycin, and
vancomycin to create eight treatment groups: no antibiotics, all antibiotics
(metronidazole, streptomycin, and vancomycin), $\Delta$metronidazole
(streptomycin and vancomycin), $\Delta$streptomycin (metronidazole and
vancomycin), $\Delta$vancomycin (metronidazole and streptomycin), metronidazole
only, streptomycin only, and vancomycin only. Each treatment group showed a
decrease in tumor multiplicity relative to the mice that did not receive
antibiotics; however, all of the antibiotic treatments resulted in varying
severity of tumorigenesis (Figure 1BC). These results demonstrate that
perturbation of the microbiota through the use of antibiotics yielded a
differential capacity for colon tumorigenesis.

2. Next, we characterized the differences in the structures of the communities by
calculating the distance between samples using a metric that incorporates the
membership and relative abundance of each OTU (i.e. $\theta$<sub>YC</sub>) [Yue and Clayton, 2005].
...
$\beta$-diversity (i.e. weighted and unweighted UniFrac). These results indicate that
highly disparate community structures can come from mice that harbor similar
numbers of tumors.

3. Marked structural changes associated with each antibiotic treatment could be
...
$\Delta$metronidazole and $\Delta$streptomycin treatments led to the dominance of
Proteobacteria (66±5% and 75±5%, respectively). The $\Delta$vancomycin treated mice
...
4. To examine the role of the microbial community in this variation in
...
5. The clear differences in community structure and composition coupled with the
...
incidence ($\Delta$metronidazole, streptomycin only, and vancomycin only; median number
of tumors=5.5) and low tumor incidence (All antibiotics and $\Delta$vancomycin,
$\Delta$streptomycin and metronidazole only median number of tumors=2.0). We then used
...
6. Interestingly, when we investigated the relative abundance of these OTUs for
...
the most tumors, $\beta$-Proteobacteria (OTU 25) was highly abundant among the
$\Delta$metronidazole group, significantly less abundant in vancomycin only group, and
completely absent from the streptomycin only group. In contrast,
*Mucinispirillum* (OTU 87) was absent in the $\Delta$metronidazole group, but elevated
