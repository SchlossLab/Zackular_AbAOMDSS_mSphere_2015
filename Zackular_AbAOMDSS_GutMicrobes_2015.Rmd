...
the tumor counts (Supplementary Figure 2).
...
plot_baseline_features(tumor_counts_baseline, importance, rf_baseline_rabund, treatment_baseline)
```
...
plot_top_features(tumor_counts_final, importance, rf_final_rabund, treatment_end)
```
