...
otu_plot <- function(rabunds, ordered_treatments, otu_label){
    ...
    text(x=0.35, y=0.95*max(rabunds), label=otu_label, pos=4, font=2, cex=1)
...
layout(design, width=c(0.13, 1), height=c(1,1,1,1,0.8))
...
plot.new()
text(x=seq(0.05,1,length=8), y=1, labels[ordered_treatments], srt=90, cex=1.2, pos=2)
